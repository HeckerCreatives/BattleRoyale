...
public class BotSwordAttackThree : BotAnimationPlayable
{
    float timer;
    ...
    public override void Enter()
    {
        ...
        botPlayables.SlashSwordParticles(2);
    ...
    public override void Exit()
    {
        ...
        botPlayables.SlashSwordParticlesStop(2);
        canAction = false;
    }

...
namespace Fusion.Sample.DedicatedServer {
  public class DedicatedServerConfig {
    ...
    public ushort SceneIndex { get; private set; }
    ...
    public static DedicatedServerConfig Resolve() {
      ...
      // Scene Index
      if (CommandLineUtils.TryGetArg(out string sceneIndex, "-index") && ushort.TryParse(sceneIndex, out var index)) {
